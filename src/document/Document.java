...
public abstract class Document {
	...
	{
		Boolean flag=false;int c=0,x=0;
		// TODO: Implement this method so that you can call it from the 
	    // getNumSyllables method in BasicDocument (module 2) and 
	    // EfficientDocument (module 3).
		word=word.toLowerCase();
		for(int i=0;i<word.length();i++) {
			if( (word.charAt(i)=='a' ||word.charAt(i)=='e' ||word.charAt(i)=='y'||word.charAt(i)=='i' ||word.charAt(i)=='o' ||word.charAt(i)=='u')  ) {
				if((i==word.length()-1 && c==0 && word.charAt(i)=='e')||word.length()==1) {
					c++;continue;
				}
				else	if(i==word.length()-1 ) {
					if(x==0 && word.charAt(i)=='e')continue;
	...
	public double getFleschScore()
	{
		...
		double a=getNumWords();
		double b=getNumSentences();
		double c=getNumSyllables();
		double d=1.015*a/b;
		double e=84.6*c/a;
	return  206.835-d-e;
